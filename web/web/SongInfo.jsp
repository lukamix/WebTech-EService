...
<div class="songInfo">
    <div class="leftSide">
        ...
        <%}%>
        <%if(request.getAttribute("songname")!=null){%>
            <div class="songName"><%=request.getAttribute("songname")%></div>
        <%}%>
        <div class="info">
            <div class="row">
                <div class ="title">Ca sĩ:</div>
                <a href="artist?artistid=<%=request.getAttribute("artist1id")%>&songpage=1&videopage=1"><%=request.getAttribute("artistname")%></a>
            </div>
            <div class="row">
